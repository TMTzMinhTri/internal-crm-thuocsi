                ...
                <MyCardContent>
                    ...
                    <Dialog open={openModal.open} scroll="body" fullWidth={true}>
                        ...
                        <DialogContent dividers>
                            <div>
                                Bạn muốn <span
                                style={{fontWeight: "bold"}}>{openModal.checked === true ? "bật" : "tắt"}</span> trạng
                                thái của chương trình <span
                                style={{fontWeight: "bold"}}>{openModal.promotionId + " - " + openModal.promotionName}</span> hay
                                không?
                            </div>
                        </DialogContent>
                        <DialogActions>
